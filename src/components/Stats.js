...
const Stats = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const movieResponse = await fetch(`http://localhost:8081/multiplex/getHighestGrossing/${longId}`);
            ...
            // try {
            //     const ticketsResponse = await fetch('http://localhost:8081/multiplex//totalTicketsThatDay/1');
