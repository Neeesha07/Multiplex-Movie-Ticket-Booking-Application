...
const UpdateMovieForm = ({ ownerId }) => {
    ...
    const handleMovieChange = (e) => {
        ...
        axios.get(`http://win10-2-186:8888/multiplex-ms/moviebyId/${movieId}`)
            .then((response) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            setLoading(true);
            await axios.put(`http://win10-2-186:8888/multiplex-ms/updatemoviedetails/${selectedMovie}`, ticketObject);
            handleClose();
