...
public class TicketBookerDaoImpl implements TicketBookerDao{
	...
	@Autowired
	MultipleDao2Impl dao2 ;
	
	@Override
	public Ticket createTicket(long bookerId, TicketRequest ticketRequest) {
		...
		String url = "http://localhost:8082/ticketBooker/createticket/"+bookerId;
