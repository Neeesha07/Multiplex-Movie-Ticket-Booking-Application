...
//	}
	...
	public double calculateTotalMoney(@PathVariable long multiplex_id, @RequestBody List<Integer> bookedSeats) {
		...
		@PostMapping("/createNewTicket/{booker_id}")
		public Ticket createTicket(@PathVariable long booker_id, @RequestBody TicketRequest ticketRequest) 
		{
			return ticketDao.createTicket(booker_id, ticketRequest);
		}
